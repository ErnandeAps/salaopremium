...
class EyeDataGrid
{
    ...
    public $img_imprimi = 'reset.png';
    public $img_sms = 'sms.png';
	...
	const TXT_NORESULTS = 'Nenhum resultado encontrado!';
	...
	public function addStandardControl($type, $action, $action_type = self::TYPE_ONCLICK)
	{
		...
		switch ($type)
		{
			...
			case self::STDCTRL_DELETE:
				...
				break;
            case self::STDCTRL_IMP:
				$this->controls[] = '<a ' . $action . '><img src="' . $this->image_path . $this->img_imprimi . '" alt="Imprimir" title="imprimir" class="tbl-control-image"></a>';
				break;
            case self::STDCTRL_SMS:
				$this->controls[] = '<a ' . $action . '><img src="' . $this->image_path . $this->img_sms . '" alt="Sms" title="Sms" class="tbl-control-image"></a>';
				break;
            default:
	...
	*/
	public function printTable()
	{
		...
		echo '</tbody>';
  //alteração de exibição do rodapé
