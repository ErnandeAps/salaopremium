...
if ($Id<>'0') {
   $query_Rsdb = "SELECT * FROM tbcadfuncionario WHERE id=$Id";
...
<link href="cadfuncionario.css" rel="stylesheet">
</head>
<body>
<div id="space"><br></div>
<div id="container">
<div id="wb_Shape1" style="position:absolute;left:72px;top:43px;width:576px;height:415px;z-index:22;">
<img src="images/img0016.png" id="Shape1" alt="" style="width:576px;height:415px;"></div>
<div id="wb_Text1" style="position:absolute;left:144px;top:70px;width:432px;height:20px;text-align:center;z-index:23;">
<span style="color:#3F9C03;font-family:Verdana;font-size:17px;"><strong>Cadastro de Funcionarios</strong></span></div>
<div id="wb_Image1" style="position:absolute;left:582px;top:392px;width:45px;height:50px;z-index:24;">
<a href="../cadastros.html"><img src="sair.jpeg" id="Image1" alt=""></a></div>
<div id="wb_Image2" style="position:absolute;left:529px;top:392px;width:48px;height:48px;z-index:25;">
<a href="./script/listcadfuncionario.php"><img src="images/localizar.jpg" id="Image2" alt=""></a></div>
<div id="wb_Form1" style="position:absolute;left:104px;top:88px;width:409px;height:352px;z-index:26;">
<form name="frmcadcliente" method="post" action="./script/addcadfuncionario.php?Id=<?php echo $Id ?>" enctype="multipart/form-data" id="Form1">
...
<label for="Editbox7" id="Label7" style="position:absolute;left:29px;top:201px;width:55px;height:16px;line-height:16px;z-index:12;">Fone fixo</label>
<input type="text" id="Editbox7" style="position:absolute;left:95px;top:201px;width:226px;height:18px;line-height:18px;z-index:13;" name="fone" value="<?php echo $fone ?>" maxlength="12" spellcheck="false">
...
<input type="submit" id="Button1" name="btincluir" value="Salvar" style="position:absolute;left:247px;top:302px;width:70px;height:35px;z-index:18;">
<input type="reset" id="Button2" name="btlimpar" value="Limpar" style="position:absolute;left:323px;top:302px;width:70px;height:35px;z-index:19;">
<select name="cargo" size="1" id="Combobox1" style="position:absolute;left:95px;top:294px;width:132px;height:30px;z-index:20;">
<option value="Adm">Administrador</option>
<option value="Prof. Cabelo">Prof. Cabelo</option>
<option value="Serviço G.">Serviço G.</option>
<option value="Atendente">Atendente</option>
</select>
<label for="Editbox9" id="Label10" style="position:absolute;left:29px;top:297px;width:50px;height:16px;line-height:16px;z-index:21;">Cargo</label>
</form>
</div>
</div>
</body>
