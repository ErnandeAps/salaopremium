...
$res = mysql_query("select * from os order by nome");
...
for($i=0; $i<$total; $i++){
	...
	echo "<td class=\"linhas\"><a href=\"../os.php?Id=$codigo\" onclick=\"EditarLinha('$id');\"><img src=\"images/editar.gif\" alt=\"Editar\" title=\"Selecionar OS\"></a></td>";
