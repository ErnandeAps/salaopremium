...
<body>
<div id="wb_Shape1" style="position:absolute;left:0px;top:2px;width:1280px;height:680px;z-index:21;">
<img src="images/img0019.png" id="Shape1" alt="" style="width:1280px;height:680px;"></div>
<div id="wb_Form2" style="position:absolute;left:27px;top:74px;width:1227px;height:591px;z-index:22;">
...
<div id="wb_Image3" style="position:absolute;left:576px;top:477px;width:79px;height:79px;z-index:8;">
<a href="./script/impticket.php"><img src="images/ticket.png" id="Image3" alt="" title="Imprimir Ticket"></a></div>
...
for($i=0; $i<$total; $i++){
	...
	echo "<td class=\"linhas\"><a href=\"excitens.php?Id=$Id&Idi=$codigo\" onclick=\"ExcluirLinha('$Id');\"><img src=\"images/excluir.gif\" alt=\"Excluir\" title=\"Excluir\"></a></td>";
}
...
<a href="./script/impcupom.php"><img src="images/cupom.jpg" id="Image2" alt="" title="Imprimir Cupom"></a></div>
<div id="wb_Image4" style="position:absolute;left:294px;top:467px;width:165px;height:99px;z-index:18;">
<a href="./script/finalizaos.php" onclick="window.location.href='./script/finalizar.php';return false;"><img src="images/finalizar.png" id="Image4" alt="" title="Finalizar"></a></div>
<input type="button" id="Button1" onclick="window.location.href='./script/selectcliente.php';return false;" name="salvar" value="Abrir OS" style="position:absolute;left:26px;top:477px;width:108px;height:67px;z-index:19;">
<input type="button" id="Button2" onclick="window.location.href='addservico.php?Id=<?php echo $Id;?>';return false;" name="salvar" value="Inc. Serviço" style="position:absolute;left:146px;top:477px;width:108px;height:67px;z-index:20;">
</form>
</div>
<div id="wb_Text1" style="position:absolute;left:40px;top:42px;width:182px;height:32px;z-index:23;">
